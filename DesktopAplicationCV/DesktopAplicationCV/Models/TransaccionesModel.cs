...
namespace DesktopAplicationCV.Models
{
    public class TransaccionesModel
    {
        ...
        public TransaccionesModel(int id_transaccion, int folio, string tipo_transaccion, string subtipo_transaccion, string moneda, DateTime fecha, string cliente, string metodo_pago, string banco, string cuenta)
        {
